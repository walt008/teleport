...
func (s *PresenceService) GetNodes(namespace string, opts ...auth.MarshalOption) ([]types.Server, error) {
	if namespace == "" {
...
// GetReverseTunnel returns reverse tunnel by name
func (s *PresenceService) GetReverseTunnel(name string, opts ...auth.MarshalOption) (types.ReverseTunnel, error) {
...
func (s *PresenceService) GetReverseTunnels(opts ...auth.MarshalOption) ([]types.ReverseTunnel, error) {
	startKey := backend.Key(reverseTunnelsPrefix)
	result, err := s.GetRange(context.TODO(), startKey, backend.RangeEnd(startKey), backend.NoLimit)
	if err != nil {
		return nil, trace.Wrap(err)
...
func (s *PresenceService) GetTunnelConnection(clusterName, connectionName string, opts ...auth.MarshalOption) (types.TunnelConnection, error) {
...
func (s *PresenceService) GetTunnelConnections(clusterName string, opts ...auth.MarshalOption) ([]types.TunnelConnection, error) {
	if clusterName == "" {
...
func (s *PresenceService) GetAllTunnelConnections(opts ...auth.MarshalOption) ([]types.TunnelConnection, error) {
...
func (s *PresenceService) GetRemoteClusters(opts ...auth.MarshalOption) ([]types.RemoteCluster, error) {
...
func (s *PresenceService) GetAppServers(ctx context.Context, namespace string, opts ...auth.MarshalOption) ([]types.Server, error) {
	if namespace == "" {
