...
type Marshaler func(types.Resource, ...auth.MarshalOption) ([]byte, error)

// Unmarshaler handles unmarshaling of a specific resource type.
type Unmarshaler func([]byte, ...auth.MarshalOption) (types.Resource, error)
...
func init() {
	RegisterResourceMarshaler(types.KindUser, func(r types.Resource, opts ...auth.MarshalOption) ([]byte, error) {
		rsc, ok := r.(types.User)
		if !ok {
	...
	RegisterResourceUnmarshaler(types.KindUser, func(b []byte, opts ...auth.MarshalOption) (types.Resource, error) {
	...
	RegisterResourceMarshaler(types.KindCertAuthority, func(r types.Resource, opts ...auth.MarshalOption) ([]byte, error) {
	...
	RegisterResourceUnmarshaler(types.KindCertAuthority, func(b []byte, opts ...auth.MarshalOption) (types.Resource, error) {
	...
	RegisterResourceMarshaler(types.KindTrustedCluster, func(r types.Resource, opts ...auth.MarshalOption) ([]byte, error) {
	...
	RegisterResourceUnmarshaler(types.KindTrustedCluster, func(b []byte, opts ...auth.MarshalOption) (types.Resource, error) {
	...
	RegisterResourceMarshaler(types.KindGithubConnector, func(r types.Resource, opts ...auth.MarshalOption) ([]byte, error) {
	...
	RegisterResourceUnmarshaler(types.KindGithubConnector, func(b []byte, opts ...auth.MarshalOption) (types.Resource, error) {
...
func MarshalResource(resource types.Resource, opts ...auth.MarshalOption) ([]byte, error) {
...
// NOTE: This function only supports the subset of resources which may be imported/exported
// by users (e.g. via `tctl get`).
func UnmarshalResource(kind string, raw []byte, opts ...auth.MarshalOption) (types.Resource, error) {
