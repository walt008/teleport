...
func UnmarshalClusterConfig(bytes []byte, opts ...auth.MarshalOption) (types.ClusterConfig, error) {
...
func MarshalClusterConfig(c types.ClusterConfig, opts ...auth.MarshalOption) ([]byte, error) {
	cfg, err := CollectOptions(opts)
	if err != nil {
		return nil, trace.Wrap(err)
	}
