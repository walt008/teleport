...
func UnmarshalStaticTokens(bytes []byte, opts ...auth.MarshalOption) (types.StaticTokens, error) {
...
func MarshalStaticTokens(c types.StaticTokens, opts ...auth.MarshalOption) ([]byte, error) {
	cfg, err := CollectOptions(opts)
	if err != nil {
		return nil, trace.Wrap(err)
	}
