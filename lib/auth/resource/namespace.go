...
func MarshalNamespace(resource types.Namespace, opts ...auth.MarshalOption) ([]byte, error) {
...
func UnmarshalNamespace(data []byte, opts ...auth.MarshalOption) (*types.Namespace, error) {
	if len(data) == 0 {
