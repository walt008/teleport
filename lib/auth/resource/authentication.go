...
func UnmarshalAuthPreference(bytes []byte, opts ...auth.MarshalOption) (types.AuthPreference, error) {
...
func MarshalAuthPreference(c types.AuthPreference, opts ...auth.MarshalOption) ([]byte, error) {
