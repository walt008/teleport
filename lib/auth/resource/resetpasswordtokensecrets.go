...
func UnmarshalResetPasswordTokenSecrets(bytes []byte, opts ...auth.MarshalOption) (types.ResetPasswordTokenSecrets, error) {
	if len(bytes) == 0 {
...
func MarshalResetPasswordTokenSecrets(secrets types.ResetPasswordTokenSecrets, opts ...auth.MarshalOption) ([]byte, error) {
