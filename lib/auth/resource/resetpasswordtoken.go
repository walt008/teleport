...
func UnmarshalResetPasswordToken(bytes []byte, opts ...auth.MarshalOption) (types.ResetPasswordToken, error) {
	if len(bytes) == 0 {
...
func MarshalResetPasswordToken(token types.ResetPasswordToken, opts ...auth.MarshalOption) ([]byte, error) {
